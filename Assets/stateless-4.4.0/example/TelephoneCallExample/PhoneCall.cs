...
namespace TelephoneCallExample
{
    public class PhoneCall
    {
        ...
        private StateMachine<State, Trigger>.TriggerWithParameters<int> _setVolumeTrigger;

        private StateMachine<State, Trigger>.TriggerWithParameters<string> _setCalleeTrigger;
