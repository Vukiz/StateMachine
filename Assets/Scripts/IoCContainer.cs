...
internal static class IoCContainer
{
	...
	public static Container.IRegisteredType Register<TInterface, TImplementation>() => _container.Register(typeof(TInterface), typeof(TImplementation));
	public static Container.IRegisteredType Register<T>(Func<T> factory) => _container.Register(typeof(T), () => factory());
